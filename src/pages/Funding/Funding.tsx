...
const Funding = () => {
    ...
    const footerTexts = [
        ...
        "In the forth column named \"Repayment Period\", you have to enter the number of years that you will have agreed to repay the borrowed amount along with the accrued interest. The simulation will automatically calculate the monthly amount of the principal borrowed amount that you will have to repay.",
        "The simulation will automatically give you the value of the Monthly Repayment with interest payable in the fifth column. The values in this column are not editable and will only change if you change the values of the borrowed amount or the annual rate of interest or repaymen period.",
        ...
        "When you have completed with filling all the details of funding click on \"SAVE DETAILS\" to get the total amount you have borrowed, the total monthly repayment with interest",
        "When you have completed with filling all the details of funding click on \"SAVE DETAILS\" to get the total amount you have borrowed, the total monthly repayment with interest, this will also highlight the Funding icon in the side navigation bar, from where you can access this section and make changes later.",
    ...
    const showNavIconIfData = () => {
        try {
            ...
            const FundingDB = localStorage.getItem('FundingDB')
            if (EMI && FundingDB != null) { setFooterVisible(false) }
