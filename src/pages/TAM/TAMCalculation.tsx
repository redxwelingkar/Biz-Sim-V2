...
const TAMCalc = () => {
  ...
  const footerTexts = [
    ...
    "Great! You have successfully defined and calculated your Total Addressable Market. To mark this milestone we have added a highlight to TAM icon on your left side navigation bar, you can use to to come back to TAM later if you need to make any changes.",
