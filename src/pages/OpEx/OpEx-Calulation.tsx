...
function OpEx() {
    ...
    const navigateToCapEx = () => {
        ...
        navigate("/Biz-Sim-V2/towards-capex")
    }
    ...
    const footerTexts = [
        ...
        "You can add more rows for adding more expenses by clicking on \"ADD EXPENSE\" button, you may edit each expense, their type and value as well or remove an expense using the [-] icon. As and when you keep adding each expense the total operational expenditure will keep getting updated at the bottom field of \"Total OpEx\".",
        "When you have completed with filling all the details of operational expenditure click on \"SAVE DETAILS\" to save your progress, this will highlight the OpEx icon in the side navigation bar, from where you can access this section and make changes later.",
                ...
                <div>
                    ...
                    <div className={FooterVisible ? "table-container opex-table-container" : "table-container opex-table-container vh-90"}>
                        ...
                        <div className="button-container">
                            <button id='AddExpenseBTN_ID' className="add-button" onClick={handleAddRow}>ADD EXPENSE</button>
                    ...
                    {FooterVisible && <Footer texts={footerTexts} onNextNavtoCapEx={navigateToCapEx} />}
                </div>
                :
                // TutorialMode=False
                <div>
